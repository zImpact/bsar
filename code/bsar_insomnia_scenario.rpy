...
label bsar_insomnia_day2:
    ...
    bsar_protagonist "Э-э-э... Коне-ечно." 
    show bsar_mz angry with dspr 
...
label bsar_insomnia_day3:
    ...
    bsar_protagonist "Ага-а. Увидимся." 
    hide bsar_us with dissolve
    stop sound_loop fadeout 2
    stop ambience fadeout 2
    scene bg black with Dissolve(1) 
    ...
    if bsar_insomnia_day2_intervene: 
        ...
        bsar_dv "Поня-ятно. Девочка-то влюбилась!" 
...
label bsar_insomnia_day3_after_dv:
    ...
    bsar_un "Да, помню, как отец наряжался в костюм Деда Мороза и выходил в подъезд, чтобы за десять минут до нового года позвонить в звонок, а затем подарить подарки. Я, конечно, всё понимала, и..." 
    ...
    bsar_protagonist "Да-а... Раньше было очень здорово." 
