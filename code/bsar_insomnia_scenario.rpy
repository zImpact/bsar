...
label bsar_insomnia_day2:
    ...
    bsar_protagonist "Конечно, Славя! Для тебя — все что угодно!" # nolint
    ...
    bsar_he "Заметь, не я это предложил. Только недолго и немного."
    ...
    bsar_us "Я не трогала его! Мы же вообще живём в разных доми..." # nolint
...
label bsar_insomnia_day3:
    ...
    bsar_us "Очень заметно! Мешки под глазами уже больше, чем сами глаза. Ходишь как живой мертвец из того фильма..." # nolint
    ...
    bsar_us "Не нравится мне твой скепти-чтоб-его-цизм." # nolint
    ...
    bsar_she "Ох, как же я не люблю, когда в твоём голосе слышны нотки скепти-чтоб-его-цизма." # nolint
    ...
    bsar_narrator "Как будто не домыли и бросили." 
...
label bsar_insomnia_day3_after_dv:
    ...
    bsar_narrator "И всё-таки Алиса была права. А ведь и вправду, на моей памяти она ни разу не ошибалась."
    ...
    $ bsar_hide_centered_text(dspr)
    bsar_narrator "Кругом мертвенная тишина, которую нарушает только гулкий стук моего сердца." # nolint
    ...
    with bsar_flash
    play ambience bsar_hum fadein 2
    bsar_she_red "Дальше я дам тебе ответы, какие смогу, но времени у нас мало и то, что ты увидишь, может повлиять на исход всего." # nolint
